...
- main:
  ...
  - img
  - text: WAN Throughput 10.9 Gbps +6.2%
  - img
  - text: Mean Latency 16.7 ms -1.1ms
  - img
  - text: Packet Loss 0.118 % +0.01
  - img
  ...
  - img
  - img
  - text: 20G 15G 10G 5G 0 Peak In 15.2 Gbps Peak Out 11.2 Gbps Drops 0.118% 95th %ile 14.8 Gbps
  ...
  - text: CPU 64.3% Memory 83.5% Storage 44.0% Load Avg 100.0%
