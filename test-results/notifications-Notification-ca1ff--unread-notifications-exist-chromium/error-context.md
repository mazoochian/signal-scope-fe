...
- Name: notifications.spec.ts >> Notification Center >> Mark all as read button is visible when unread notifications exist
- Location: e2e/tests/notifications.spec.ts:46:7
...
Locator: getByRole('button', { name: /Mark all as read/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Mark all as read/i })
...
- banner:
  ...
  - combobox:
    ...
    - option "1m"
    - option "5m"
  - button "Open notification center": "3"
  - button "Add device"
...
- main:
  ...
  - img
  - text: WAN Throughput 10.3 Gbps +6.2%
  - img
  - text: Mean Latency 16.5 ms -1.1ms
  - img
  - text: Packet Loss 0.121 % +0.01
  - img
  ...
  - img
  - img
  - text: 20G 15G 10G 5G 0 Peak In 15.2 Gbps Peak Out 11.0 Gbps Drops 0.121% 95th %ile 14.8 Gbps
  ...
  - text: CPU 58.6% Memory 83.7% Storage 44.0% Load Avg 100.0%
