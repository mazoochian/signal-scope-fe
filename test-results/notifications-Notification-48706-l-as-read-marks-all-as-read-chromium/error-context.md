...
- Name: notifications.spec.ts >> Notification Center >> clicking mark all as read marks all as read
- Location: e2e/tests/notifications.spec.ts:56:7
...
- main:
  ...
  - img
  - text: WAN Throughput 10.7 Gbps +6.2%
  - img
  - text: Mean Latency 16.4 ms -1.1ms
  - img
  - text: Packet Loss 0.127 % +0.01
  - img
  ...
  - img
  - img
  - text: 20G 15G 10G 5G 0 Peak In 15.2 Gbps Peak Out 11.8 Gbps Drops 0.127% 95th %ile 14.8 Gbps
  ...
  - text: CPU 77.5% Memory 82.7% Storage 44.0% Load Avg 100.0%
