...
- main:
  ...
  - img
  - text: WAN Throughput 14.4 Gbps +6.2%
  - img
  - text: Mean Latency 17.7 ms -1.1ms
  - img
  - text: Packet Loss 0.123 % +0.01
  - img
  ...
  - img
  - img
  - text: 20G 15G 10G 5G 0 Peak In 15.2 Gbps Peak Out 10.1 Gbps Drops 0.123% 95th %ile 14.8 Gbps
  ...
  - text: CPU 64.8% Memory 83.6% Storage 44.0% Load Avg 74.5%
